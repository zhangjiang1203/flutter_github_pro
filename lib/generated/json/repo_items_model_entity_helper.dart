...
repoItemsModelEntityFromJson(RepoItemsModelEntity data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['owner'] != null) {
		data.owner = new RepoItemsModelOwner().fromJson(json['owner']);
	}
	...
	if (json['license'] != null) {
		data.license = new RepoItemsModelLicense().fromJson(json['license']);
	}
	if (json['forks'] != null) {
...
Map<String, dynamic> repoItemsModelEntityToJson(RepoItemsModelEntity entity) {
...
repoItemsModelOwnerFromJson(RepoItemsModelOwner data, Map<String, dynamic> json) {
	if (json['login'] != null) {
...
Map<String, dynamic> repoItemsModelOwnerToJson(RepoItemsModelOwner entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
repoItemsModelLicenseFromJson(RepoItemsModelLicense data, Map<String, dynamic> json) {
	if (json['key'] != null) {
...
Map<String, dynamic> repoItemsModelLicenseToJson(RepoItemsModelLicense entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['key'] = entity.key;
	data['name'] = entity.name;
