/*
* my_infinite_listview created by zj
* on 2020/6/11 10:44 AM
...
class MyInfiniteListView<T> extends StatefulWidget {
  MyInfiniteListView({
    Key key,
  ...
  @override
  _MyInfiniteListViewState<T> createState() => new _MyInfiniteListViewState<T>();
