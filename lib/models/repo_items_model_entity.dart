...
class RepoItemsModelEntity with JsonConvert<RepoItemsModelEntity> {
	int id;
...
class RepoItemsModelOwner with JsonConvert<RepoItemsModelOwner> {
	String login;
	int id;
	@JSONField(name: "node_id")
	String nodeId;
...
class RepoItemsModelLicense with JsonConvert<RepoItemsModelLicense> {
	String key;
	String name;
