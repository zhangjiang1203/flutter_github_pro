...
import 'package:fluttergithubpro/routes/lifeToolsPage/jin_ri_you_jia_page.dart';
import 'package:fluttergithubpro/routes/lifeToolsPage/news_top_page.dart';
import 'package:fluttergithubpro/routes/lifeToolsPage/today_in_history_page.dart';
import 'package:fluttergithubpro/routes/lifeToolsPage/xiao_hua_da_quan_page.dart';
...
class _LifePage extends State<LifePage> {
  ...
  void _pushToDefinePage(String e){
    if ("top_news" == e){
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: (_){
        return JinRiYouJiaPage();
      }));
    }else if(e == 'jokes'){
      Navigator.of(context).push(MaterialPageRoute(builder: (_){
        return XiaoHuaDaQuanPage();
      }));
    }
    else if(e == 'history_today'){
      Navigator.of(context).push(MaterialPageRoute(builder: (_){
        return TodayInHistoryPage();
      }));
    }
  }
